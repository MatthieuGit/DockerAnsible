...
createNodes() {
	...
	for i in $(seq $min $max);do
		docker run -tid --privileged --publish-all=true -v /srv/data:/srv/html  --privileged --cgroupns=host -v /sys/fs/cgroup:/sys/fs/cgroup:rw --name $USER-debian-$i -h $USER-debian-$i priximmo/buster-systemd-ssh
